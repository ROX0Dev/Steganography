...
public class Steganography {
	...
	private static final String MESSAGE_TO_HIDE = "Hello World!";
	
	private static final String ORIGINAL_IMAGE = "resources/World.png";
	...
	int myPixel = imageArray[row][col];
	System.out.printf("0x%08X\n\n", myPixel);
	   int aValue = ((myPixel >> 18) & 0x000000c0);
	   int rValue = ((myPixel >> 12) & 0x00000030);
	   int gValue = ((myPixel >> 6)  & 0x0000000c);
	   int bValue = ((myPixel >> 0)  & 0x00000003);
	   System.out.printf("0x%08X, 0x%08X, 0x%08X, 0x%08X\n", aValue, rValue, gValue, bValue);
	   System.out.printf("0x%08X\n\n", myPixel);
	   byteArray[byteArrIndex] = (byte)(aValue|rValue|gValue|bValue);
}
